...
<body>
     ...
     */
        ...
        echo 'naam: ', ucfirst($naam), '<br>';
        echo 'straat: ', ucfirst($straat), '<br>';

        if (is_numeric($huisnummer)) {
            echo 'postcode: ', $huisnummer, '<br>';
        } else {
            echo "<script>alert('Niet beveiligd tegen script-injections')</script>", '<br>';
        }

        echo 'postcode: ', strtolower($postcode), '<br>';
        echo 'woonplaats: ', ucfirst($woonplaats), '<br>';
